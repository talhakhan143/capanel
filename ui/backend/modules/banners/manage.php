                ...
                <div class="col-md-6">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <p class="panel-subtitle">It's easy to create custom graphs on Porto Admin Template, there
                                are
                                        ...
                                        <div id="collapse1Two" class="accordion-body collapse">
                                            <div class="panel-body">
                                                <ul class="simple-user-list mb-xlg">
                                                    ...
                                                    <li>
                                                        <figure class="image rounded">
                                                            <img src="images/!sample-user.jpg" alt="Joe Junior"
                                                                 class="img-circle">
                                                        </figure>
                                    ...
                                    <ol class="tm-items">
                                        <li>
                                            <div class="tm-box">
                                                ...
                                                <p>
                                                    It's awesome when we find a good solution for our projects, Porto
                                                    Admin is
                                            ...
                                            <div class="tm-box">
                                                ...
                                                <div class="thumbnail-gallery">
                                                    <a class="img-thumbnail lightbox"
                                                       href="images/projects/project-4.jpg"
