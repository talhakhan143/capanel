                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal form-bordered" action="<?=$frmAction?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select data-plugin-selecttwo="" class="form-control" name="cat">
                                            <option value="">Select Category</option>
                                            <?php foreach($portCats as $portCat){ ?>
                                                <option value="<?=$portCat['pcat_id']?>" <?=($editData[$base_class->getDbPrefix("cat")] == $portCat['pcat_id'] ? "selected" : "")?>><?=$portCat['pcat_title']?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
